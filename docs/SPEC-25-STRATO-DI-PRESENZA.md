...
| **Tacche su una fascia riempita sopra L 48** | **`--cy-900`** — il dettaglio si **inverte**, non sparisce | Una tacca si legge per **contrasto** contro il proprio fondo: su un fondo chiaro va scura. ⚠️ Questa riga è stata scritta il 23 agosto 2026 come «**nessuna**» e corretta lo stesso giorno: veniva da un ritaglio a 9× che mostrava il *corpo* delle fasce chiare del riferimento liscio. Un secondo ritaglio, in un altro punto, mostra il dettaglio al loro **bordo interno** — che è esattamente dove `ReactorRing` disegna le proprie tacche. Reso senza tacche, il nucleo perdeva il dettaglio su tre fasce su cinque e leggeva come un disco pieno |
